...
let newNumber = true //no inicío deve ser um novo número
let operator //vai guardar o meu operador
let previousNumber //vai guardar o meu número
...
document.addEventListener('keydown', mapKeyboard) //keydown vai substituir o clique con o mouse
